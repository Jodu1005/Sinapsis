...
export function TaskDetailPanel({ details, onQueueInput, onReview, onRequeue, onReadArtifact }: { details: TaskDetailView; onQueueInput(body: string): Promise<void>; onReview(action: 'accept' | 'return'): Promise<void>; onRequeue?(): Promise<void>; onReadArtifact(artifactId: string): Promise<string> }) {
