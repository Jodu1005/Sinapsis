...
export function ChannelTimeline({ messages, typingAgents = [], onOpenThread }: { messages: ChannelMessage[]; typingAgents?: AgentView[]; onOpenThread?(message: ChannelMessage): void }) {
