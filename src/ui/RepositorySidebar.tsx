...
export function RepositorySidebar({ workspace, workspaces, selectedChannelId, selectedTaskId, onSelectWorkspace, onSelectChannel, onSelectTask, onCreateTask, onCreateChannel, onArchiveChannel, onRestoreChannel, channelReadOnly, onCreateWorkspace, onSelectAgent, onCreateAgent, mobileOpen, mobileHidden, onClose }: RepositorySidebarProps) {
