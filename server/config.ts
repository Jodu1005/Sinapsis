...
export function getServiceConfig(environment = process.env): ServiceConfig {
  return {
    ...
    maxInitialSpeakers: parsePositiveInteger(environment.SINAPSIS_MAX_INITIAL_SPEAKERS, defaultMaxInitialSpeakers, 'SINAPSIS_MAX_INITIAL_SPEAKERS'),
    maxConversationRounds: parsePositiveInteger(environment.SINAPSIS_MAX_CONVERSATION_ROUNDS, defaultMaxConversationRounds, 'SINAPSIS_MAX_CONVERSATION_ROUNDS'),
